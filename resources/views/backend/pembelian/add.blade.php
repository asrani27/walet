          ...
          <div class="col-4">
            <div class="card card-outline card-primary">
                ...
                <form class="form-horizontal" method="POST" action="{{route('tambahkeranjang')}}">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">bahan</label>
                      <div class="col-sm-9">
                          <select name="bahan_id" class="form-control form-control-sm" required>
                              <option value="">-pilih-</option>
                  ...
                  <tbody>
                      @foreach ($keranjang as $item)
                        <tr>
                            ...
                            <td>{{$item->jumlah}}</td>
                            <td>{{$item->bahan->stok + $item->jumlah}}</td>
                            <td>@currency($item->bahan->harga_beli)</td>
                            <td>@currency($item->jumlah * $item->bahan->harga_beli)</td>
                            <td>
