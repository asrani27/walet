...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transaksi Pesanan Gedung</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <form class="form-horizontal" method="POST" action="{{route('penjualan')}}">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          <select name="pelanggan_id" class="form-control form-control-sm" required>
                      ...
                      <label for="inputEmail3" class="col-sm-2 col-form-label">DP /Uang Muka</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control form-control-sm" name="dp" value="" required>
                      </div>
                    </div>
          ...
          <div class="col-4">
            <div class="card card-outline card-primary">
                ...
                <form class="form-horizontal" method="POST" action="{{route('tambahkeranjang')}}">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">gedung</label>
                      <div class="col-sm-9">
                          <select name="gedung_id" class="form-control form-control-sm" required>
                              <option value="">-pilih-</option>
                ...
                <table class="table table-bordered table-striped table-sm">
                  ...
                  <tbody>
                      @foreach ($keranjang as $item)
                        <tr>
                            <td>{{$no++}}</td>
                            <td>{{$item->gedung->kode}}</td>
                            <td>{{$item->gedung->jenis}}</td>
                            <td>{{$item->gedung->ukuran}}</td>
                            <td>{{$item->jumlah}}</td>
                            <td>@currency($item->gedung->harga)</td>
                            <td>@currency($item->jumlah * $item->gedung->harga)</td>
                            <td>
