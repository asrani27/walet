          ...
          <div class="col-12">
            <div class="card card-outline card-primary">
              <div class="card-header">
                <a href="/upah/add" class="btn btn-sm btn-primary">Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                      @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <a href="/upah/edit/{{$item->id}}" class="btn btn-xs bg-gradient-warning"><i class="fas fa-edit"></i></a>
                                <a href="/upah/delete/{{$item->id}}" class="btn btn-xs bg-gradient-danger" onclick="return confirm('Yakin Menghapus Data Ini?');"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                      @endforeach
